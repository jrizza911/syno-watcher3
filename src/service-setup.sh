...
WATCHER="${SYNOPKG_PKGDEST}/share/Watcher3/watcher.py"
CFG_FILE="${SYNOPKG_PKGDEST}/var/config.ini"
LOG_FILE="${SYNOPKG_PKGDEST}/var/logs/watcher.log"

SERVICE_COMMAND="${PYTHON} ${WATCHER} --daemon --pidfile ${PID_FILE} --config ${CFG_FILE} --datadir ${SYNOPKG_PKGDEST}/var/"
